...
/**
 * מעבר לטאב אחר. יושב כאן מאותה סיבה בדיוק כמו הרענון: דיאלוג הפוסט
 * קופץ לטאב התוכן, וההתראות קופצות לקמפיין — בלי ההיפוך הזה כל מודול
 * שמנווט היה צריך להכיר את הניווט של האפליקציה ואת כל הרנדררים שמאחוריו.
 */
export const goToTab = (tab) => reg.goToTab?.(tab)
